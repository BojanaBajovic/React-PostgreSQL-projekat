   ...
   render() {
      ...
      return (
         <Container fluid className="centered">                 
            <Jumbotron style={{width: '100%', height: 700}}>
               <Row>
                  <Col>   
                     <h1 className="display-4" style={{fontSize: 38, paddingBottom: 30}}>Izaberite recept</h1>             
                     <FormGroup>
                        ...
                        <div style={{paddingTop: 40, marginLeft: 25}}>
                        {selectedObject}
                        {selectedObject1}
                        </div>       
                     </FormGroup>
